 ...
 PARAMETER NAME = C:\DevGIT\SDK_test\freertos_zynq_bsp_0\system.mss
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = Data_Mover_Bridge_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = IIC_Controllers_axi_iic_Ch1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = IIC_Controllers_axi_iic_Ch2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = IIC_Controllers_axi_iic_Ch3
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = IIC_Controllers_axi_iic_Ch4
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = IIC_Controllers_axi_iic_Ch5
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = iic
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = IIC_Controllers_axi_iic_Ch6
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = master_controller_0
END
